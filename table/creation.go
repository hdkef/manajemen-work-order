...
var RP_REJECTED_CREATION = fmt.Sprintf("CREATE TABLE IF NOT EXISTS %s(id INT AUTO_INCREMENT PRIMARY KEY, rp_id INT NOT NULL, date_created DATE NOT NULL, creator_id INT NOT NULL,msg TEXT NOT NULL, FOREIGN KEY (rp_id) REFERENCES rp(id), FOREIGN KEY (creator_id) REFERENCES entity(id))", RP_REJECTED)
